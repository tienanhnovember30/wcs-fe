    ...
    <div>
      <div className="w-[1140px] mx-auto ">
        <div className="text-2xl py-[25px]">
          <span>Trang chủ</span>{" "}
          <span className="text-[#E22C43]">Giỏ hàng</span>
        </div>
        <div className="oder-table">
          <table className="w-full mt-[30px]">
            <thead>
              <tr>
                <th className="border-solid border-2 border-[#C4C4C4] h-[60px] w-[444px]">
                  TÊN SẢN PHẨM{" "}
                </th>
                <th className="border-solid border-2 border-[#C4C4C4]  h-[60px]">
                  GIÁ
                </th>
                <th className="border-solid border-2 border-[#C4C4C4]  h-[60px]">
                  SỐ LƯỢNG{" "}
                </th>
                <th className="border-solid border-2 border-[#C4C4C4] p-auto  h-[60px]">
                  TỔNG{" "}
                </th>
                <th className="border-solid border-2 border-[#C4C4C4] p-auto  h-[60px] w-[157px]">
                  HỦY ĐƠN HÀNG
                </th>
              </tr>
            </thead>
              ...
              <tr className="border-solid border-2 border-[#C4C4C4] ">
                <th className="flex ">
                  <img
                    ...
                    className="ml-[20px] mt-[34px] mb-[34px] h-[120px] w-[100px]"
                    alt=""
                  />
          ...
          <div className=" relative ">
            <button className="w-[340px] h-[60px] bg-black text-slate-50 mt-[55px] rounded-[4px] absolute right-0 hover:bg-orange-500">
